...
class OpenBlock(models.TransientModel):
    ...
    _description = "Wizard Buka Blokir Akun Santri"
                ...
                if santri_aktif:
                    return {
                        'warning': {
                            ...
                            'message': f"Kartu ditemukan untuk '{santri_aktif.name}', tetapi akun saat ini sudah aktif."
                        }
                    }
                else:
                    return {
    ...
    def action_submit(self):
        ...
        message = f"Akun santri {self.santri_id.name} telah berhasil diaktifkan kembali (Buka Blokir)."
